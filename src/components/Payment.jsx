...
const Payment = () => {
  ...
  return (
    ...
    <h2 className='payment-content fw'>PAYMENT METHOD</h2>
    <div className='row'>
    <div>
      {selectedCard ? (
        <div className='col-md-9 payment-content fw'>
          ...
          <div className="form-check default-address">
                ...
                <label htmlFor="defaultAddress" className='default-label-text fw'>Billing address same as Shipping Address</label>
            </div>
            <div className='col'>
