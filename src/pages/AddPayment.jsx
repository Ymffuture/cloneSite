...
const AddPayment = () => {
        ...
        <>
            <div className="container-pay">
                <div className="container select-card">
                    ...
                    <div className="select-card">
                    <FontAwesomeIcon icon={faCreditCard} />{'  '} VISA Debit ending in 2894
                    </div>
    ...
    <input type="checkbox" name="defaultPayment" value={formData.defaultPayment} onChange={handleChange} className="form-check-input custom-checkbox" id="defaultPayment" />
